...
import { mdiAccount, mdiHome, mdiLoginVariant } from '@mdi/js';
...
<template>
    <Card :centered="true">
        <div class="flex-c ai-c jc-c" style="gap: 1rem;">
            <h1 v-if="session">A user session is currently active! Please go home or logout.</h1>
            ...
            <div class="flex-r jc-sb w-100" style="gap: 0.5rem;">
                ...
                <button @click="$router.push({name: 'account'})" v-if="session" class="flex-r ai-c w-100" style="gap: 5px;">
