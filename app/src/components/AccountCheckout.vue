...
<template>
    <transition>
        <modal v-if="addressModalShow" @close-modal="addressModalShow = false" title="New Address">
    ...
    <form @submit.prevent="placeOrder" class="flex-c h-100" style="flex-wrap: wrap; gap: 0.5rem;">
        ...
        <button v-if="paymentMethodId != 3" style="margin-top: auto; height: 3.5rem;" type="submit" :disabled="!meta.valid">Place Order</button>
    </form>
</template>
